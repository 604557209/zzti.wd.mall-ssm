  ...
  <div class="container-fluid" style="height:auto">
        <div class="main" style="height:auto">
          ...
          <div class="table-responsive">
			<form id="addBookform" action="<c:url value='/addbook.do'/>" method="post" enctype="multipart/form-data">
			  <div class="form-group">
			    <label for="exampleInputEmail1">封面</label>
			    <div class="input-group" style="width:30%">
			    	<input type="file" class="checkNull" name="file" size="50"/>
      			</div>
			  </div>
			  <div class="form-group">
			    <label for="exampleInputEmail1">书名</label>
			    <div class="input-group" style="width:30%">
				    <input type="text" name="brand" class="form-control checkNull" id="user_code" placeholder="请输入图书名称"/>
      			</div>
			  </div>
			  <div class="form-group">
			    <label for="exampleInputPassword1">作者</label>
			    <div class="input-group" style="width:30%">
		       		<input type="text" name="book_author" class="form-control checkNull" id="pay_total" placeholder="请输入作者姓名"/>
			    </div>
			   </div>
			   <div class="form-group">
			   		<label for="exampleInputPassword1">出版社</label>
			   	 <div class="input-group" style="width:30%">
			   			<input name="book_press" class="form-control checkNull" id="user_surplus" type="text" placeholder="请输入出版社名称"/>
			   	 </div>
			   </div>
			   <div class="form-group">
			   		<label for="exampleInputPassword1">ISBN号码</label>
			   	 <div class="input-group" style="width:30%">
			   			<input name="book_isbn" class="form-control checkNull checkDigit" id="user_surplus" type="text" placeholder="由纯数字组成"/>
			   	 </div>
			   </div>
			   <div class="form-group">
			   		<label for="exampleInputPassword1">页数</label>
			   	 <div class="input-group" style="width:30%">
			   			<input name="book_pages" class="form-control checkNull checkDigit" id="user_surplus" type="text" placeholder="请输入图书总页数"/>
			   	 </div>
			   </div>
			   <div class="form-group">
