		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<form name="updateBookForm" id="updateBookForm" action="updatecomputer.do" method="post">
						<table>
							<input type="hidden" name="id" id="update_id"/>
							<tr>
								<td>
									<div class="form-group">
										<label for="recipient-name" class="control-label" id="label_address">品牌：</label>						
								...
								<td>
									<div class="form-group">
										<label for="recipient-name" class="control-label" id="label_address">型号：</label> 
							...
							<tr>
								<td>
									<div class="form-group">
										<label for="recipient-name" class="control-label" id="label_address">屏幕尺寸：</label> 
								...
								<td>
									<div class="form-group">
										<label for="recipient-name" class="control-label" id="label_address">重量：</label>
	...
	<nav class="navbar navbar-default" style="margin-top:2%;height:auto">
		<div class="container-fluid" style="height:auto">
			<div class="main" style="height:auto">
				<h2 class="sub-header">笔记本信息列表</h2>
						...
						<tbody>
							<c:forEach var="a" items="${list}">
								<tr>
									...
									<td id="list_author_${a.id}">${a.pc_model}</td>
									<td id="list_press_${a.id}">${a.pc_size}</td>
									<td id="list_isbn_${a.id}">${a.pc_weight}</td>
									...
									<td>
										...
										&nbsp;&nbsp;<button type="button" data-toggle="modal" data-target="#delete_small_ModalLabel" class="btn btn-primary btn-danger btn-xs" onclick="deleteF('deletecomputer.do?id=${a.id}&pic=${a.pic}')">删除</button>
									</td>
								</tr>
							</c:forEach>
						</tbody>
