      ...
      <div class="row" style="height:100%">
        <div class="col-sm-3 col-md-2 sidebar">
          ...
          <li class="active"><a href="#">快速操作 <span class="sr-only">(current)</span></a></li>
            ...
            <li id="li_2" class="lihref"><a href="#" onclick="javascript:alter_href('/backpages/addcomputer.jsp',2);">添加电脑信息</a></li>
          </ul>
		  <ul class="nav nav-sidebar">
            <li class="active"><a href="#">信息查看 <span class="sr-only">(current)</span></a></li>
            <li id="li_4" class="lihref"><a href="#" onclick="javascript:alter_href('listbook.do',4);">图书列表</a></li>
            <li id="li_5" class="lihref"><a href="#" onclick="javascript:alter_href('listcomputer.do',5);">电脑列表</a></li>
          </ul> 
        </div>
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2" style="height:100%;">
        	<iframe id="iframe" frameborder="no" border="0"  style="height:100%;width:100%;" src="<c:url value='/listbook.do'/>"></iframe>
        </div>
      </div>
    </div>
  </body>
