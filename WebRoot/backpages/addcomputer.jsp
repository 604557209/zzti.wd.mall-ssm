...
<html lang="zh-CN" style="height:auto">
  ...
  <div class="container-fluid" style="height:auto">
        <div class="main" style="height:auto">
          <h2 class="sub-header">添加电脑信息</h2>
          <div class="table-responsive">
			<form id="addBookform" action="<c:url value='/addcomputer.do'/>" method="post" enctype="multipart/form-data">
			  ...
			  <div class="form-group">
			    ...
			    <div class="input-group" style="width:30%">
		       		<input type="text" name="pc_model" class="form-control checkNull" id="pay_total" placeholder="请输入作者姓名"/>
			    </div>
			   </div>
			   <div class="form-group">
			   		<label for="exampleInputPassword1">屏幕尺寸</label>
			   	 <div class="input-group" style="width:30%">
			   			<input name="pc_size" class="form-control checkNull" id="user_surplus" type="text" placeholder="请输入出版社名称"/>
			   	 </div>
			   </div>
			   <div class="form-group">
			   		<label for="exampleInputPassword1">重量</label>
			   	 <div class="input-group" style="width:30%">
			   			<input name="pc_weight" class="form-control checkNull checkDigit" id="user_surplus" type="text" placeholder="由纯数字组成"/>
			   	 </div>
			   </div>
			   <div class="form-group">
