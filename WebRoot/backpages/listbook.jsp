		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<form name="updateBookForm" id="updateBookForm" action="updatebook.do" method="post">
						<table>
							...
							<tr>
								<td>
									<div class="form-group">
									    ...
									    <input type="text" name="brand" class="form-control checkForm_null" id="update_name" placeholder="请输入图书名称">
					      			</div>
								</td>
								...
								<td>
									<div class="form-group">
										...
										<input type="text" name="book_author" class="form-control checkForm_null" id="update_author">
									</div>
								</td>
							</tr>
							<tr>
								<td>
									<div class="form-group">
										...
										<input type="text" name="book_press" class="form-control checkForm_null" id="update_press">
									</div>
								</td>
								<td style="width:30px;"></td>
								<td>
									<div class="form-group">
										...
										<input type="text" name="book_isbn" class="form-control checkForm_null checkForm_digit" id="update_isbn">
									</div>
								</td>
							</tr>
							<tr>
								<td>
									<div class="form-group">
										...
										<input type="text" name="book_pages" class="form-control checkForm_null checkForm_digit" id="update_number">
									</div>			
								</td>
								<td style="width:30px;"></td>
								<td>
					...
					<table class="table table-striped" style="font-size:14px;">
						...
						<tbody>
							<c:forEach var="a" items="${list}">
								<tr>
									<td id="list_name_${a.id}">${a.brand}</td>
									<td id="list_author_${a.id}">${a.book_author}</td>
									<td id="list_press_${a.id}">${a.book_press}</td>
									<td id="list_isbn_${a.id}">${a.book_isbn}</td>
									<td id="list_number_${a.id}">${a.book_pages}</td>
									<td id="list_price_${a.id}">${a.price}</td>
									<td>
										<button type="button" class="btn btn-primary btn-xs" onclick="updateF(${a.id},'${a.pic}');" data-toggle="modal" data-target="#add_update_Modal">修改</button>
										&nbsp;&nbsp;<button type="button" data-toggle="modal" data-target="#delete_small_ModalLabel" class="btn btn-primary btn-danger btn-xs" onclick="deleteF('deletebook.do?id=${a.id}&pic=${a.pic}')">删除</button>
									</td>
								</tr>
							</c:forEach>
						</tbody>
