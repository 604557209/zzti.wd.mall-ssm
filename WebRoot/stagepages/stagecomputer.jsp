...
<div class="w_100_l">
	<div class="main">
      <div class="top_banner">
            <div class="top_menu">
            	<ul>
                	<li><a href="book.do">图书</a></li>
                	<li class="sel"><a href="computer.do">笔记本电脑</a></li>
                </ul>
            </div>
        ...
        <p class="index_hr"></p>
      <div class="content">
            <h1 class="h1_book_title">笔记本商城</h1>
        	<ul>
        	<c:forEach var="b" items="${list}">
            	<li style="width:30%">
                	<dl>
                    	<dd><a href="#"><img src="<c:url value='/upload/${b.pic}'/>" alt="book" /></a></dd>
                        <dt style="margin-left: 10px;">
                        	<p class="book_title"><a href="#" target="_blank">品牌：${b.brand}</a></p>
                        	<p class="book_inline" style="margin-bottom: 0px;">型号：${b.pc_model}</p>
                            <p class="book_inline" style="margin-bottom: 0px; color:red">￥${b.price}</p>
                        	<p class="book_inline">尺寸：${b.pc_size}</p>
