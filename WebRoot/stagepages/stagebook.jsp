...
<div class="w_100_l">
	<div class="main">
      <div class="top_banner">
            <div class="top_menu">
            	<ul>
                	<li class="sel"><a href="book.do">图书</a></li>
                	<li><a href="computer.do">笔记本电脑</a></li>
                </ul>
            </div>
            	...
            	<li style="width:30%">
                	<dl>
                        ...
                        <dt style="margin-left: 10px;">
                        	<p class="book_title"><a href="#" target="_blank">${b.brand}</a></p>
                        	<p class="book_inline" style="margin-bottom: 0px;">${b.book_author}</p>
                            <p class="book_inline" style="margin-bottom: 0px; color:red">￥${b.price}</p>
                        	<p class="book_inline">${b.book_press}</p>
